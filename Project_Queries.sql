...
-- ==============================================================================
-- This file contains the queries specifically designed to meet the rubric requirements:
-- CRUD operations, JOINs, Subqueries, Aggregation, and Conditions.
-- Copy these into your Lab Report/Documentation.
